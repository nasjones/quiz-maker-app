		...
		return (
			<div>
				<div className="createWrap">
					...
					<form id="quizForm">
						<FormHead
							subAttempt={this.state.subAttempt}
							category={this.state.category}
							title={this.state.title}
						...
						<Question
							...
							questChange={this.questChange}
							ansChange={this.answerChange}
							corChange={this.correctChange}
							bool={this.state.subAttempt}
